...
Due to the difficulty that can arise with two people on the same R script and trying to push that  script at the same time, Cheyenne and Justin verbally discussed the answers to all questions with only one person typing on the actual R script. 