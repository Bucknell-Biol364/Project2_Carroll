...
KF: I assume that this was done offline.
...
KF: For the items marked n/a, were they not relevant or were they missing?
Didn't they do ChIP-Seq? Or was it just ChIP-on-Chip?
...
KF: Describe what data that you would need in order to confrim the analysis.   
...
KF: You mention this briefly on the Prereg Template, but more detail is needed for each of the three major classes of QRP.  
...
KF: I know this was frustrating to try to complete. (I think I may eliminate this paper next year.)  
